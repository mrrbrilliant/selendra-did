    ...
    return (
          ...
          <div className="dropdown w-full">
            <label tabIndex={0} className="input-group input m-0 p-0">
              <input
                ...
                value={selectedOrg !== -1 ? organizations.filter((o) => o.id == selectedOrg)[0].name : ""}
                readOnly={true}
              />
      ...
      <div>
        <div className="flex justify-end rounded-xl mt-6">
          <label onClick={toggleCreateOpen} className="btn bg-accent rounded-xl modal-button" htmlFor="my-modal-3">
        ...
        <div className="grid grid-cols-2 mt-3 gap-7">
          {data.map((res, index) => {
            return (
              <div key={index} className=" rounded-lg p-3  border-gray-100 bg-white">
